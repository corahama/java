...
public class JavaApplication2 {
    ...
    public static void main(String[] args) throws Exception {
        String secretKey = "estaeslacontraseña";
        String Texto = "Palabra";
        System.out.println(Texto);
        System.out.println(Encriptar(Texto,secretKey));
        String Texto2 = Encriptar(Texto,secretKey);
        System.out.println(Desencriptar(Texto2,secretKey));
