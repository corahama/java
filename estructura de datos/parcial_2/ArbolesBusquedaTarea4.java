...
public class ArbolesBusquedaTarea4 { 
    public static void main(String[] args) {
        ...
        System.out.println("Factores de equilibrio");
        System.out.println(7 + " fe: " + factorEquilibrio(buscar(numeros, 7)));
        System.out.println(22 + " fe: " + factorEquilibrio(buscar(numeros, 22)));
        ...
        System.out.println("Factores de equilibrio");
        System.out.println(8 + " fe: " + factorEquilibrio(buscar(numeros, 8)));
        System.out.println(22 + " fe: " + factorEquilibrio(buscar(numeros, 22)));
    ...
    public static int altura(NodoArbol n) {
        ...
        int alturaIzquierdo = altura(n.i);
        // Calcular altura del derecho
        int alturaDerecho = altura(n.d);
        // Comparar
        int mayor;
        if (alturaIzquierdo > alturaDerecho)
            mayor = alturaIzquierdo;
        else
            mayor = alturaDerecho;
    ...
    public static int factorEquilibrio(NodoArbol n) {
        // Completar factor de equilibro
        int fe = altura(n.i) - altura(n.d);
        return fe;
    }
